...
def calculate_2020euro(value, reference_year, if_usd):
    HICP = {2011:95.36,
            2012:97.88,
            2013:99.35,
            2014:99.90,
            ...
            2020:106.20}
    if not if_usd:
        print(value*106.20/HICP[reference_year])
    else:
        print(value*106.20/HICP[reference_year]*0.84)
    return

if __name__ == '__main__':
    a = capital_recovery_factor(rate= 0.1, life= 20)
    print(a)
    ...
    #                         length_project=20))
    # calculate_2020euro(224, 2018, if_usd= False)
